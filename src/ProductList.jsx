                ...
                <div className="tag">
                    <div className="luxury">
                        ...
                        <a href="/" style={{textDecoration:'none'}}>
                            <div>
                                <h3 style={{color:'white'}}>Yang Plant Nursery</h3>
                                <i style={{color:'white'}}>Breathe Green 🌱</i>
                            </div>
                        </a>
                    </div>
                </div>
                <div style={styleObjUl}>
                    <div> <a className="plantsStyle" href="#" onClick={(e)=>handlePlantsClick(e)} style={{...styleA, marginRight: '10px'}}>Plants</a></div>
                    <div> 
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                ...
                                <div className={`cart-quantity-count ${totalItems > 9 ? 'double-digits': ''}`}>{totalItems}</div>
                            </h1>
                        </a>
                    </div>
                </div>
                    ...
                    plantsArray.map((plantType,index) => (
                        <div key={index}>
                            <div className='plantname_heading'>
                                <h1 className="plant_heading">{plantType.category}</h1>
                            </div>
                            <div className="product-list">
                                {plantType.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <button onClick={()=>handleAddToCart(plant)} className={`product-button ${isPlantInCart(plant) ? 'added-to-cart' : ''}`} disabled={isPlantInCart(plant)} style={isPlantInCart(plant) ? { cursor: 'not-allowed' } : {}}>{isPlantInCart(plant) ? "Added to Cart" : "Add to Cart"}</button>
                                    </div>
                                ))}
                            </div>
                        </div>
